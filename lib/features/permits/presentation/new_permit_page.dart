...
class _NewPermitPageState extends ConsumerState<NewPermitPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final types = sectorId == null ? const AsyncValue.data([]) : ref.watch(undertakingTypesProvider(sectorId!));
