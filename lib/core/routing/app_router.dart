      ...
      routes: [
        ...
        ShellRoute(
          ...
          routes: [
            ...
            GoRoute(path: '/permits', builder: (_, __) => const _PlaceholderPage(title: 'Permit Registry')),
            GoRoute(path: '/permits/new', builder: (_, __) => const _PlaceholderPage(title: 'New Permit Registration')),
